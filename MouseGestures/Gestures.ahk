...
m_LowThreshold = 50     ; Minimum distance to register as a gesture "stroke." 25
...
m_PenWidth =  10          ; Width of the pen to draw trails with.
m_NodePenWidth =   20     ; Radius of "nodes" on the trails, indicating where each stroke begins.
m_PenColor =  FFFF11          ; Colour of trails and nodes. originally 112211
m_TransTrail = 0        ; Make trail window transparent (recommended if DWM/Aero theme is enabled).
...
#Include MouseGestures\Gestures_User.ahk       ; User-defined gestures, etc.
#Include MouseGestures\Gestures_Default.ahk    ; Default gestures.
